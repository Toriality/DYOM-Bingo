...
export const timer = {
    ...
    display: (current, pb) => {
        ...
        let hrs = Math.floor((current/(1000*60*60))%24).toString().padStart(2, "0");
        let mins = Math.floor((current/(1000*60))%60).toString().padStart(2, "0");
        let secs = Math.floor((current/1000)%60).toString().padStart(2, "0");
        let mils = Math.floor((current%1000)/10).toString().padStart(2, "0");
